...
public class _Demo
{
    public static int Main(string[] args)
    {
        ...
        //
        System.Console.Write("INTERPOLATION BY LINEAR SPLINE");
        ...
        spline1d.spline1dbuildlinear(x, y, n, ref s);
        ...
        System.Console.WriteLine();
        System.Console.Write("Try other demos (spline1d_hermite, spline1d_cubic) and compare errors...");
        System.Console.WriteLine();
        System.Console.WriteLine();
        System.Console.WriteLine();
        return 0;
