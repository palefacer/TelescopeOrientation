...
public class _Demo
{
    public static int Main(string[] args)
    {
        ...
        //
        System.Console.Write("INTERPOLATION BY NATURAL CUBIC SPLINE");
        ...
        spline1d.spline1dbuildcubic(x, y, n, 1, +1, 1, -1, ref s);
        ...
        System.Console.WriteLine();
        System.Console.Write("Try other demos (spline1d_linear, spline1d_hermite) and compare errors...");
        System.Console.WriteLine();
        System.Console.WriteLine();
        System.Console.WriteLine();
        return 0;
