...
IF EXIST * DEL /F /Q *
CHDIR ..
IF "%~1"=="csc" GOTO lbl_7_csc
IF "%~1"=="mono" GOTO lbl_7_mono
GOTO lbl_7___error
:lbl_7_csc
...
EXIT /B 1
:lbl_7___end
IF "%~2"=="autogk_singular" GOTO lbl_10_autogk_singular
IF "%~2"=="autogk_smooth" GOTO lbl_10_autogk_smooth
IF "%~2"=="minlbfgs_1" GOTO lbl_10_minlbfgs_1
IF "%~2"=="lsfit_linear" GOTO lbl_10_lsfit_linear
IF "%~2"=="lsfit_nonlinear" GOTO lbl_10_lsfit_nonlinear
IF "%~2"=="lsfit_nonlinear2" GOTO lbl_10_lsfit_nonlinear2
IF "%~2"=="minlm_fgh" GOTO lbl_10_minlm_fgh
IF "%~2"=="minlm_fgj" GOTO lbl_10_minlm_fgj
IF "%~2"=="minlm_fj" GOTO lbl_10_minlm_fj
IF "%~2"=="minlm_fj2" GOTO lbl_10_minlm_fj2
IF "%~2"=="mlp_process" GOTO lbl_10_mlp_process
IF "%~2"=="mlp_process_cls" GOTO lbl_10_mlp_process_cls
IF "%~2"=="mlp_randomize" GOTO lbl_10_mlp_randomize
IF "%~2"=="mlp_serialize" GOTO lbl_10_mlp_serialize
IF "%~2"=="ode_example1" GOTO lbl_10_ode_example1
IF "%~2"=="ode_example2" GOTO lbl_10_ode_example2
IF "%~2"=="polint_cheb1" GOTO lbl_10_polint_cheb1
IF "%~2"=="polint_cheb2" GOTO lbl_10_polint_cheb2
IF "%~2"=="polint_eqdist" GOTO lbl_10_polint_eqdist
IF "%~2"=="polint_fit" GOTO lbl_10_polint_fit
IF "%~2"=="polint_gen" GOTO lbl_10_polint_gen
IF "%~2"=="ratint_fit" GOTO lbl_10_ratint_fit
IF "%~2"=="rcond_1" GOTO lbl_10_rcond_1
IF "%~2"=="spline1d_calc" GOTO lbl_10_spline1d_calc
IF "%~2"=="spline1d_cubic" GOTO lbl_10_spline1d_cubic
IF "%~2"=="spline1d_fit" GOTO lbl_10_spline1d_fit
IF "%~2"=="spline1d_fitc" GOTO lbl_10_spline1d_fitc
IF "%~2"=="spline1d_hermite" GOTO lbl_10_spline1d_hermite
IF "%~2"=="spline1d_linear" GOTO lbl_10_spline1d_linear
IF "%~2"=="minlbfgs_2" GOTO lbl_10_minlbfgs_2
IF "%~2"=="mincg_2" GOTO lbl_10_mincg_2
IF "%~2"=="mincg_1" GOTO lbl_10_mincg_1
IF "%~2"=="minasa_1" GOTO lbl_10_minasa_1
IF "%~2"=="minasa_2" GOTO lbl_10_minasa_2
GOTO lbl_10___error
:lbl_10_autogk_singular
COPY examples\_demo_autogk_singular.cs _tmp\_demo.cs > NUL 2> NUL
GOTO lbl_10___end
:lbl_10_autogk_smooth
COPY examples\_demo_autogk_smooth.cs _tmp\_demo.cs > NUL 2> NUL
GOTO lbl_10___end
:lbl_10_minlbfgs_1
COPY examples\_demo_minlbfgs_1.cs _tmp\_demo.cs > NUL 2> NUL
GOTO lbl_10___end
:lbl_10_lsfit_linear
COPY examples\_demo_lsfit_linear.cs _tmp\_demo.cs > NUL 2> NUL
GOTO lbl_10___end
:lbl_10_lsfit_nonlinear
COPY examples\_demo_lsfit_nonlinear.cs _tmp\_demo.cs > NUL 2> NUL
GOTO lbl_10___end
:lbl_10_lsfit_nonlinear2
COPY examples\_demo_lsfit_nonlinear2.cs _tmp\_demo.cs > NUL 2> NUL
GOTO lbl_10___end
:lbl_10_minlm_fgh
COPY examples\_demo_minlm_fgh.cs _tmp\_demo.cs > NUL 2> NUL
GOTO lbl_10___end
:lbl_10_minlm_fgj
COPY examples\_demo_minlm_fgj.cs _tmp\_demo.cs > NUL 2> NUL
GOTO lbl_10___end
:lbl_10_minlm_fj
COPY examples\_demo_minlm_fj.cs _tmp\_demo.cs > NUL 2> NUL
GOTO lbl_10___end
:lbl_10_minlm_fj2
COPY examples\_demo_minlm_fj2.cs _tmp\_demo.cs > NUL 2> NUL
GOTO lbl_10___end
:lbl_10_mlp_process
COPY examples\_demo_mlp_process.cs _tmp\_demo.cs > NUL 2> NUL
GOTO lbl_10___end
:lbl_10_mlp_process_cls
COPY examples\_demo_mlp_process_cls.cs _tmp\_demo.cs > NUL 2> NUL
GOTO lbl_10___end
:lbl_10_mlp_randomize
COPY examples\_demo_mlp_randomize.cs _tmp\_demo.cs > NUL 2> NUL
GOTO lbl_10___end
:lbl_10_mlp_serialize
COPY examples\_demo_mlp_serialize.cs _tmp\_demo.cs > NUL 2> NUL
GOTO lbl_10___end
:lbl_10_ode_example1
COPY examples\_demo_ode_example1.cs _tmp\_demo.cs > NUL 2> NUL
GOTO lbl_10___end
:lbl_10_ode_example2
COPY examples\_demo_ode_example2.cs _tmp\_demo.cs > NUL 2> NUL
GOTO lbl_10___end
:lbl_10_polint_cheb1
COPY examples\_demo_polint_cheb1.cs _tmp\_demo.cs > NUL 2> NUL
GOTO lbl_10___end
:lbl_10_polint_cheb2
COPY examples\_demo_polint_cheb2.cs _tmp\_demo.cs > NUL 2> NUL
GOTO lbl_10___end
:lbl_10_polint_eqdist
COPY examples\_demo_polint_eqdist.cs _tmp\_demo.cs > NUL 2> NUL
GOTO lbl_10___end
:lbl_10_polint_fit
COPY examples\_demo_polint_fit.cs _tmp\_demo.cs > NUL 2> NUL
GOTO lbl_10___end
:lbl_10_polint_gen
COPY examples\_demo_polint_gen.cs _tmp\_demo.cs > NUL 2> NUL
GOTO lbl_10___end
:lbl_10_ratint_fit
COPY examples\_demo_ratint_fit.cs _tmp\_demo.cs > NUL 2> NUL
GOTO lbl_10___end
:lbl_10_rcond_1
COPY examples\_demo_rcond_1.cs _tmp\_demo.cs > NUL 2> NUL
GOTO lbl_10___end
:lbl_10_spline1d_calc
COPY examples\_demo_spline1d_calc.cs _tmp\_demo.cs > NUL 2> NUL
GOTO lbl_10___end
:lbl_10_spline1d_cubic
COPY examples\_demo_spline1d_cubic.cs _tmp\_demo.cs > NUL 2> NUL
GOTO lbl_10___end
:lbl_10_spline1d_fit
COPY examples\_demo_spline1d_fit.cs _tmp\_demo.cs > NUL 2> NUL
GOTO lbl_10___end
:lbl_10_spline1d_fitc
COPY examples\_demo_spline1d_fitc.cs _tmp\_demo.cs > NUL 2> NUL
GOTO lbl_10___end
:lbl_10_spline1d_hermite
COPY examples\_demo_spline1d_hermite.cs _tmp\_demo.cs > NUL 2> NUL
GOTO lbl_10___end
:lbl_10_spline1d_linear
COPY examples\_demo_spline1d_linear.cs _tmp\_demo.cs > NUL 2> NUL
GOTO lbl_10___end
:lbl_10_minlbfgs_2
COPY examples\_demo_minlbfgs_2.cs _tmp\_demo.cs > NUL 2> NUL
GOTO lbl_10___end
:lbl_10_mincg_2
COPY examples\_demo_mincg_2.cs _tmp\_demo.cs > NUL 2> NUL
GOTO lbl_10___end
:lbl_10_mincg_1
COPY examples\_demo_mincg_1.cs _tmp\_demo.cs > NUL 2> NUL
GOTO lbl_10___end
:lbl_10_minasa_1
COPY examples\_demo_minasa_1.cs _tmp\_demo.cs > NUL 2> NUL
GOTO lbl_10___end
:lbl_10_minasa_2
COPY examples\_demo_minasa_2.cs _tmp\_demo.cs > NUL 2> NUL
GOTO lbl_10___end
:lbl_10___error
echo unknown example
EXIT /B 1
:lbl_10___end
IF "%~1"=="csc" GOTO lbl_11_csc
IF "%~1"=="mono" GOTO lbl_11_mono
GOTO lbl_11___error
:lbl_11_csc
CHDIR _tmp
csc /nowarn:0162,0169,0219 /nologo /target:exe /out:_demo.exe %~3  /reference:libalglib.dll *.cs >> ../log.txt 2>&1
...
:lbl_11_mono
CHDIR _tmp
CALL mcs /nowarn:0162,0169,0219 /target:exe /out:_demo.exe %~3  /reference:libalglib.dll *.cs >> ../log.txt 2>&1
