...
IF EXIST * DEL /F /Q *
CHDIR ..
IF "%~1"=="csc" GOTO lbl_207_csc
IF "%~1"=="mono" GOTO lbl_207_mono
...
EXIT /B 1
:lbl_207___end
IF "%~2"=="dforest" GOTO lbl_210_dforest
IF "%~2"=="dforest_silent" GOTO lbl_210_dforest_silent
IF "%~2"=="dforest_short" GOTO lbl_210_dforest_short
IF "%~2"=="tsort" GOTO lbl_210_tsort
IF "%~2"=="tsort_silent" GOTO lbl_210_tsort_silent
IF "%~2"=="tsort_short" GOTO lbl_210_tsort_short
IF "%~2"=="descriptivestatistics" GOTO lbl_210_descriptivestatistics
IF "%~2"=="descriptivestatistics_silent" GOTO lbl_210_descriptivestatistics_silent
IF "%~2"=="descriptivestatistics_short" GOTO lbl_210_descriptivestatistics_short
IF "%~2"=="bdss" GOTO lbl_210_bdss
IF "%~2"=="bdss_silent" GOTO lbl_210_bdss_silent
IF "%~2"=="bdss_short" GOTO lbl_210_bdss_short
IF "%~2"=="kmeans" GOTO lbl_210_kmeans
IF "%~2"=="kmeans_silent" GOTO lbl_210_kmeans_silent
IF "%~2"=="kmeans_short" GOTO lbl_210_kmeans_short
IF "%~2"=="blas" GOTO lbl_210_blas
IF "%~2"=="blas_silent" GOTO lbl_210_blas_silent
IF "%~2"=="blas_short" GOTO lbl_210_blas_short
IF "%~2"=="lda" GOTO lbl_210_lda
IF "%~2"=="lda_silent" GOTO lbl_210_lda_silent
IF "%~2"=="lda_short" GOTO lbl_210_lda_short
IF "%~2"=="hblas" GOTO lbl_210_hblas
IF "%~2"=="hblas_silent" GOTO lbl_210_hblas_silent
IF "%~2"=="hblas_short" GOTO lbl_210_hblas_short
IF "%~2"=="reflections" GOTO lbl_210_reflections
IF "%~2"=="reflections_silent" GOTO lbl_210_reflections_silent
IF "%~2"=="reflections_short" GOTO lbl_210_reflections_short
IF "%~2"=="creflections" GOTO lbl_210_creflections
IF "%~2"=="creflections_silent" GOTO lbl_210_creflections_silent
IF "%~2"=="creflections_short" GOTO lbl_210_creflections_short
IF "%~2"=="sblas" GOTO lbl_210_sblas
IF "%~2"=="sblas_silent" GOTO lbl_210_sblas_silent
IF "%~2"=="sblas_short" GOTO lbl_210_sblas_short
IF "%~2"=="ablasf" GOTO lbl_210_ablasf
IF "%~2"=="ablasf_silent" GOTO lbl_210_ablasf_silent
IF "%~2"=="ablasf_short" GOTO lbl_210_ablasf_short
IF "%~2"=="ablas" GOTO lbl_210_ablas
IF "%~2"=="ablas_silent" GOTO lbl_210_ablas_silent
IF "%~2"=="ablas_short" GOTO lbl_210_ablas_short
IF "%~2"=="ortfac" GOTO lbl_210_ortfac
IF "%~2"=="ortfac_silent" GOTO lbl_210_ortfac_silent
IF "%~2"=="ortfac_short" GOTO lbl_210_ortfac_short
IF "%~2"=="rotations" GOTO lbl_210_rotations
IF "%~2"=="rotations_silent" GOTO lbl_210_rotations_silent
IF "%~2"=="rotations_short" GOTO lbl_210_rotations_short
IF "%~2"=="hsschur" GOTO lbl_210_hsschur
IF "%~2"=="hsschur_silent" GOTO lbl_210_hsschur_silent
IF "%~2"=="hsschur_short" GOTO lbl_210_hsschur_short
IF "%~2"=="evd" GOTO lbl_210_evd
IF "%~2"=="evd_silent" GOTO lbl_210_evd_silent
IF "%~2"=="evd_short" GOTO lbl_210_evd_short
IF "%~2"=="hqrnd" GOTO lbl_210_hqrnd
IF "%~2"=="hqrnd_silent" GOTO lbl_210_hqrnd_silent
IF "%~2"=="hqrnd_short" GOTO lbl_210_hqrnd_short
IF "%~2"=="matgen" GOTO lbl_210_matgen
IF "%~2"=="matgen_silent" GOTO lbl_210_matgen_silent
IF "%~2"=="matgen_short" GOTO lbl_210_matgen_short
IF "%~2"=="trfac" GOTO lbl_210_trfac
IF "%~2"=="trfac_silent" GOTO lbl_210_trfac_silent
IF "%~2"=="trfac_short" GOTO lbl_210_trfac_short
IF "%~2"=="trlinsolve" GOTO lbl_210_trlinsolve
IF "%~2"=="trlinsolve_silent" GOTO lbl_210_trlinsolve_silent
IF "%~2"=="trlinsolve_short" GOTO lbl_210_trlinsolve_short
IF "%~2"=="safesolve" GOTO lbl_210_safesolve
IF "%~2"=="safesolve_silent" GOTO lbl_210_safesolve_silent
IF "%~2"=="safesolve_short" GOTO lbl_210_safesolve_short
IF "%~2"=="rcond" GOTO lbl_210_rcond
IF "%~2"=="rcond_silent" GOTO lbl_210_rcond_silent
IF "%~2"=="rcond_short" GOTO lbl_210_rcond_short
IF "%~2"=="matinv" GOTO lbl_210_matinv
IF "%~2"=="matinv_silent" GOTO lbl_210_matinv_silent
IF "%~2"=="matinv_short" GOTO lbl_210_matinv_short
IF "%~2"=="linreg" GOTO lbl_210_linreg
IF "%~2"=="linreg_silent" GOTO lbl_210_linreg_silent
IF "%~2"=="linreg_short" GOTO lbl_210_linreg_short
IF "%~2"=="gammafunc" GOTO lbl_210_gammafunc
IF "%~2"=="gammafunc_silent" GOTO lbl_210_gammafunc_silent
IF "%~2"=="gammafunc_short" GOTO lbl_210_gammafunc_short
IF "%~2"=="normaldistr" GOTO lbl_210_normaldistr
IF "%~2"=="normaldistr_silent" GOTO lbl_210_normaldistr_silent
IF "%~2"=="normaldistr_short" GOTO lbl_210_normaldistr_short
IF "%~2"=="igammaf" GOTO lbl_210_igammaf
IF "%~2"=="igammaf_silent" GOTO lbl_210_igammaf_silent
IF "%~2"=="igammaf_short" GOTO lbl_210_igammaf_short
IF "%~2"=="bdsvd" GOTO lbl_210_bdsvd
IF "%~2"=="bdsvd_silent" GOTO lbl_210_bdsvd_silent
IF "%~2"=="bdsvd_short" GOTO lbl_210_bdsvd_short
IF "%~2"=="svd" GOTO lbl_210_svd
IF "%~2"=="svd_silent" GOTO lbl_210_svd_silent
IF "%~2"=="svd_short" GOTO lbl_210_svd_short
IF "%~2"=="logit" GOTO lbl_210_logit
IF "%~2"=="logit_silent" GOTO lbl_210_logit_silent
IF "%~2"=="logit_short" GOTO lbl_210_logit_short
IF "%~2"=="mlpbase" GOTO lbl_210_mlpbase
IF "%~2"=="mlpbase_silent" GOTO lbl_210_mlpbase_silent
IF "%~2"=="mlpbase_short" GOTO lbl_210_mlpbase_short
IF "%~2"=="xblas" GOTO lbl_210_xblas
IF "%~2"=="xblas_silent" GOTO lbl_210_xblas_silent
IF "%~2"=="xblas_short" GOTO lbl_210_xblas_short
IF "%~2"=="densesolver" GOTO lbl_210_densesolver
IF "%~2"=="densesolver_silent" GOTO lbl_210_densesolver_silent
IF "%~2"=="densesolver_short" GOTO lbl_210_densesolver_short
IF "%~2"=="mlpe" GOTO lbl_210_mlpe
IF "%~2"=="mlpe_silent" GOTO lbl_210_mlpe_silent
IF "%~2"=="mlpe_short" GOTO lbl_210_mlpe_short
IF "%~2"=="linmin" GOTO lbl_210_linmin
IF "%~2"=="linmin_silent" GOTO lbl_210_linmin_silent
IF "%~2"=="linmin_short" GOTO lbl_210_linmin_short
IF "%~2"=="minlbfgs" GOTO lbl_210_minlbfgs
IF "%~2"=="minlbfgs_silent" GOTO lbl_210_minlbfgs_silent
IF "%~2"=="minlbfgs_short" GOTO lbl_210_minlbfgs_short
IF "%~2"=="mlptrain" GOTO lbl_210_mlptrain
IF "%~2"=="mlptrain_silent" GOTO lbl_210_mlptrain_silent
IF "%~2"=="mlptrain_short" GOTO lbl_210_mlptrain_short
IF "%~2"=="pca" GOTO lbl_210_pca
IF "%~2"=="pca_silent" GOTO lbl_210_pca_silent
IF "%~2"=="pca_short" GOTO lbl_210_pca_short
IF "%~2"=="odesolver" GOTO lbl_210_odesolver
IF "%~2"=="odesolver_silent" GOTO lbl_210_odesolver_silent
IF "%~2"=="odesolver_short" GOTO lbl_210_odesolver_short
IF "%~2"=="conv" GOTO lbl_210_conv
IF "%~2"=="conv_silent" GOTO lbl_210_conv_silent
IF "%~2"=="conv_short" GOTO lbl_210_conv_short
IF "%~2"=="ftbase" GOTO lbl_210_ftbase
IF "%~2"=="ftbase_silent" GOTO lbl_210_ftbase_silent
IF "%~2"=="ftbase_short" GOTO lbl_210_ftbase_short
IF "%~2"=="fft" GOTO lbl_210_fft
IF "%~2"=="fft_silent" GOTO lbl_210_fft_silent
IF "%~2"=="fft_short" GOTO lbl_210_fft_short
IF "%~2"=="corr" GOTO lbl_210_corr
IF "%~2"=="corr_silent" GOTO lbl_210_corr_silent
IF "%~2"=="corr_short" GOTO lbl_210_corr_short
IF "%~2"=="fht" GOTO lbl_210_fht
IF "%~2"=="fht_silent" GOTO lbl_210_fht_silent
IF "%~2"=="fht_short" GOTO lbl_210_fht_short
IF "%~2"=="autogk" GOTO lbl_210_autogk
IF "%~2"=="autogk_silent" GOTO lbl_210_autogk_silent
IF "%~2"=="autogk_short" GOTO lbl_210_autogk_short
IF "%~2"=="gq" GOTO lbl_210_gq
IF "%~2"=="gq_silent" GOTO lbl_210_gq_silent
IF "%~2"=="gq_short" GOTO lbl_210_gq_short
IF "%~2"=="gkq" GOTO lbl_210_gkq
IF "%~2"=="gkq_silent" GOTO lbl_210_gkq_silent
IF "%~2"=="gkq_short" GOTO lbl_210_gkq_short
IF "%~2"=="lsfit" GOTO lbl_210_lsfit
IF "%~2"=="lsfit_silent" GOTO lbl_210_lsfit_silent
IF "%~2"=="lsfit_short" GOTO lbl_210_lsfit_short
IF "%~2"=="minlm" GOTO lbl_210_minlm
IF "%~2"=="minlm_silent" GOTO lbl_210_minlm_silent
IF "%~2"=="minlm_short" GOTO lbl_210_minlm_short
IF "%~2"=="polint" GOTO lbl_210_polint
IF "%~2"=="polint_silent" GOTO lbl_210_polint_silent
IF "%~2"=="polint_short" GOTO lbl_210_polint_short
IF "%~2"=="ratinterpolation" GOTO lbl_210_ratinterpolation
IF "%~2"=="ratinterpolation_silent" GOTO lbl_210_ratinterpolation_silent
IF "%~2"=="ratinterpolation_short" GOTO lbl_210_ratinterpolation_short
IF "%~2"=="ratint" GOTO lbl_210_ratint
IF "%~2"=="ratint_silent" GOTO lbl_210_ratint_silent
IF "%~2"=="ratint_short" GOTO lbl_210_ratint_short
IF "%~2"=="apserv" GOTO lbl_210_apserv
IF "%~2"=="apserv_silent" GOTO lbl_210_apserv_silent
IF "%~2"=="apserv_short" GOTO lbl_210_apserv_short
IF "%~2"=="spline2d" GOTO lbl_210_spline2d
IF "%~2"=="spline2d_silent" GOTO lbl_210_spline2d_silent
IF "%~2"=="spline2d_short" GOTO lbl_210_spline2d_short
IF "%~2"=="spline3" GOTO lbl_210_spline3
IF "%~2"=="spline3_silent" GOTO lbl_210_spline3_silent
IF "%~2"=="spline3_short" GOTO lbl_210_spline3_short
IF "%~2"=="spline1d" GOTO lbl_210_spline1d
IF "%~2"=="spline1d_silent" GOTO lbl_210_spline1d_silent
IF "%~2"=="spline1d_short" GOTO lbl_210_spline1d_short
IF "%~2"=="idwint" GOTO lbl_210_idwint
IF "%~2"=="idwint_silent" GOTO lbl_210_idwint_silent
IF "%~2"=="idwint_short" GOTO lbl_210_idwint_short
IF "%~2"=="nearestneighbor" GOTO lbl_210_nearestneighbor
IF "%~2"=="nearestneighbor_silent" GOTO lbl_210_nearestneighbor_silent
IF "%~2"=="nearestneighbor_short" GOTO lbl_210_nearestneighbor_short
IF "%~2"=="pspline" GOTO lbl_210_pspline
IF "%~2"=="pspline_silent" GOTO lbl_210_pspline_silent
IF "%~2"=="pspline_short" GOTO lbl_210_pspline_short
IF "%~2"=="matdet" GOTO lbl_210_matdet
IF "%~2"=="matdet_silent" GOTO lbl_210_matdet_silent
IF "%~2"=="matdet_short" GOTO lbl_210_matdet_short
IF "%~2"=="sdet" GOTO lbl_210_sdet
IF "%~2"=="sdet_silent" GOTO lbl_210_sdet_silent
IF "%~2"=="sdet_short" GOTO lbl_210_sdet_short
IF "%~2"=="ldlt" GOTO lbl_210_ldlt
IF "%~2"=="ldlt_silent" GOTO lbl_210_ldlt_silent
IF "%~2"=="ldlt_short" GOTO lbl_210_ldlt_short
IF "%~2"=="spdgevd" GOTO lbl_210_spdgevd
IF "%~2"=="spdgevd_silent" GOTO lbl_210_spdgevd_silent
IF "%~2"=="spdgevd_short" GOTO lbl_210_spdgevd_short
IF "%~2"=="sinverse" GOTO lbl_210_sinverse
IF "%~2"=="sinverse_silent" GOTO lbl_210_sinverse_silent
IF "%~2"=="sinverse_short" GOTO lbl_210_sinverse_short
IF "%~2"=="inverseupdate" GOTO lbl_210_inverseupdate
IF "%~2"=="inverseupdate_silent" GOTO lbl_210_inverseupdate_silent
IF "%~2"=="inverseupdate_short" GOTO lbl_210_inverseupdate_short
IF "%~2"=="srcond" GOTO lbl_210_srcond
IF "%~2"=="srcond_silent" GOTO lbl_210_srcond_silent
IF "%~2"=="srcond_short" GOTO lbl_210_srcond_short
IF "%~2"=="ssolve" GOTO lbl_210_ssolve
IF "%~2"=="ssolve_silent" GOTO lbl_210_ssolve_silent
IF "%~2"=="ssolve_short" GOTO lbl_210_ssolve_short
IF "%~2"=="estnorm" GOTO lbl_210_estnorm
IF "%~2"=="estnorm_silent" GOTO lbl_210_estnorm_silent
IF "%~2"=="estnorm_short" GOTO lbl_210_estnorm_short
IF "%~2"=="schur" GOTO lbl_210_schur
IF "%~2"=="schur_silent" GOTO lbl_210_schur_silent
IF "%~2"=="schur_short" GOTO lbl_210_schur_short
IF "%~2"=="mincg" GOTO lbl_210_mincg
IF "%~2"=="mincg_silent" GOTO lbl_210_mincg_silent
IF "%~2"=="mincg_short" GOTO lbl_210_mincg_short
IF "%~2"=="minasa" GOTO lbl_210_minasa
IF "%~2"=="minasa_silent" GOTO lbl_210_minasa_silent
IF "%~2"=="minasa_short" GOTO lbl_210_minasa_short
IF "%~2"=="airyf" GOTO lbl_210_airyf
IF "%~2"=="airyf_silent" GOTO lbl_210_airyf_silent
IF "%~2"=="airyf_short" GOTO lbl_210_airyf_short
IF "%~2"=="bessel" GOTO lbl_210_bessel
IF "%~2"=="bessel_silent" GOTO lbl_210_bessel_silent
IF "%~2"=="bessel_short" GOTO lbl_210_bessel_short
IF "%~2"=="betaf" GOTO lbl_210_betaf
IF "%~2"=="betaf_silent" GOTO lbl_210_betaf_silent
IF "%~2"=="betaf_short" GOTO lbl_210_betaf_short
IF "%~2"=="chebyshev" GOTO lbl_210_chebyshev
IF "%~2"=="chebyshev_silent" GOTO lbl_210_chebyshev_silent
IF "%~2"=="chebyshev_short" GOTO lbl_210_chebyshev_short
IF "%~2"=="dawson" GOTO lbl_210_dawson
IF "%~2"=="dawson_silent" GOTO lbl_210_dawson_silent
IF "%~2"=="dawson_short" GOTO lbl_210_dawson_short
IF "%~2"=="elliptic" GOTO lbl_210_elliptic
IF "%~2"=="elliptic_silent" GOTO lbl_210_elliptic_silent
IF "%~2"=="elliptic_short" GOTO lbl_210_elliptic_short
IF "%~2"=="expintegrals" GOTO lbl_210_expintegrals
IF "%~2"=="expintegrals_silent" GOTO lbl_210_expintegrals_silent
IF "%~2"=="expintegrals_short" GOTO lbl_210_expintegrals_short
IF "%~2"=="fresnel" GOTO lbl_210_fresnel
IF "%~2"=="fresnel_silent" GOTO lbl_210_fresnel_silent
IF "%~2"=="fresnel_short" GOTO lbl_210_fresnel_short
IF "%~2"=="hermite" GOTO lbl_210_hermite
IF "%~2"=="hermite_silent" GOTO lbl_210_hermite_silent
IF "%~2"=="hermite_short" GOTO lbl_210_hermite_short
IF "%~2"=="ibetaf" GOTO lbl_210_ibetaf
IF "%~2"=="ibetaf_silent" GOTO lbl_210_ibetaf_silent
IF "%~2"=="ibetaf_short" GOTO lbl_210_ibetaf_short
IF "%~2"=="jacobianelliptic" GOTO lbl_210_jacobianelliptic
IF "%~2"=="jacobianelliptic_silent" GOTO lbl_210_jacobianelliptic_silent
IF "%~2"=="jacobianelliptic_short" GOTO lbl_210_jacobianelliptic_short
IF "%~2"=="laguerre" GOTO lbl_210_laguerre
IF "%~2"=="laguerre_silent" GOTO lbl_210_laguerre_silent
IF "%~2"=="laguerre_short" GOTO lbl_210_laguerre_short
IF "%~2"=="legendre" GOTO lbl_210_legendre
IF "%~2"=="legendre_silent" GOTO lbl_210_legendre_silent
IF "%~2"=="legendre_short" GOTO lbl_210_legendre_short
IF "%~2"=="psif" GOTO lbl_210_psif
IF "%~2"=="psif_silent" GOTO lbl_210_psif_silent
IF "%~2"=="psif_short" GOTO lbl_210_psif_short
IF "%~2"=="trigintegrals" GOTO lbl_210_trigintegrals
IF "%~2"=="trigintegrals_silent" GOTO lbl_210_trigintegrals_silent
IF "%~2"=="trigintegrals_short" GOTO lbl_210_trigintegrals_short
IF "%~2"=="binomialdistr" GOTO lbl_210_binomialdistr
IF "%~2"=="binomialdistr_silent" GOTO lbl_210_binomialdistr_silent
IF "%~2"=="binomialdistr_short" GOTO lbl_210_binomialdistr_short
IF "%~2"=="nearunityunit" GOTO lbl_210_nearunityunit
IF "%~2"=="nearunityunit_silent" GOTO lbl_210_nearunityunit_silent
IF "%~2"=="nearunityunit_short" GOTO lbl_210_nearunityunit_short
IF "%~2"=="chisquaredistr" GOTO lbl_210_chisquaredistr
IF "%~2"=="chisquaredistr_silent" GOTO lbl_210_chisquaredistr_silent
IF "%~2"=="chisquaredistr_short" GOTO lbl_210_chisquaredistr_short
IF "%~2"=="correlation" GOTO lbl_210_correlation
IF "%~2"=="correlation_silent" GOTO lbl_210_correlation_silent
IF "%~2"=="correlation_short" GOTO lbl_210_correlation_short
IF "%~2"=="fdistr" GOTO lbl_210_fdistr
IF "%~2"=="fdistr_silent" GOTO lbl_210_fdistr_silent
IF "%~2"=="fdistr_short" GOTO lbl_210_fdistr_short
IF "%~2"=="correlationtests" GOTO lbl_210_correlationtests
IF "%~2"=="correlationtests_silent" GOTO lbl_210_correlationtests_silent
IF "%~2"=="correlationtests_short" GOTO lbl_210_correlationtests_short
IF "%~2"=="studenttdistr" GOTO lbl_210_studenttdistr
IF "%~2"=="studenttdistr_silent" GOTO lbl_210_studenttdistr_silent
IF "%~2"=="studenttdistr_short" GOTO lbl_210_studenttdistr_short
IF "%~2"=="jarquebera" GOTO lbl_210_jarquebera
IF "%~2"=="jarquebera_silent" GOTO lbl_210_jarquebera_silent
IF "%~2"=="jarquebera_short" GOTO lbl_210_jarquebera_short
IF "%~2"=="mannwhitneyu" GOTO lbl_210_mannwhitneyu
IF "%~2"=="mannwhitneyu_silent" GOTO lbl_210_mannwhitneyu_silent
IF "%~2"=="mannwhitneyu_short" GOTO lbl_210_mannwhitneyu_short
IF "%~2"=="poissondistr" GOTO lbl_210_poissondistr
IF "%~2"=="poissondistr_silent" GOTO lbl_210_poissondistr_silent
IF "%~2"=="poissondistr_short" GOTO lbl_210_poissondistr_short
IF "%~2"=="stest" GOTO lbl_210_stest
IF "%~2"=="stest_silent" GOTO lbl_210_stest_silent
IF "%~2"=="stest_short" GOTO lbl_210_stest_short
IF "%~2"=="studentttests" GOTO lbl_210_studentttests
IF "%~2"=="studentttests_silent" GOTO lbl_210_studentttests_silent
IF "%~2"=="studentttests_short" GOTO lbl_210_studentttests_short
IF "%~2"=="variancetests" GOTO lbl_210_variancetests
IF "%~2"=="variancetests_silent" GOTO lbl_210_variancetests_silent
IF "%~2"=="variancetests_short" GOTO lbl_210_variancetests_short
IF "%~2"=="wsr" GOTO lbl_210_wsr
IF "%~2"=="wsr_silent" GOTO lbl_210_wsr_silent
IF "%~2"=="wsr_short" GOTO lbl_210_wsr_short
GOTO lbl_210___error
:lbl_210_dforest
COPY _internal\_run_testforestunit.cs _tmp\_test.cs > NUL 2> NUL
COPY tests\testforestunit.* _tmp > NUL 2> NUL
GOTO lbl_210___end
:lbl_210_dforest_short
COPY _internal\_run_short_testforestunit.cs _tmp\_test.cs > NUL 2> NUL
COPY tests\testforestunit.* _tmp > NUL 2> NUL
GOTO lbl_210___end
:lbl_210_dforest_silent
...
EXIT /B 0
GOTO lbl_210___end
:lbl_210_ablasf_short
EXIT /B 0
GOTO lbl_210___end
:lbl_210_ablasf_silent
EXIT /B 0
GOTO lbl_210___end
:lbl_210_ablas
...
COPY tests\testablasunit.* _tmp > NUL 2> NUL
GOTO lbl_210___end
:lbl_210_ablas_silent
COPY _internal\_run_silent_testablasunit.cs _tmp\_test.cs > NUL 2> NUL
COPY tests\testablasunit.* _tmp > NUL 2> NUL
GOTO lbl_210___end
:lbl_210_ortfac
COPY _internal\_run_testortfacunit.cs _tmp\_test.cs > NUL 2> NUL
COPY tests\testortfacunit.* _tmp > NUL 2> NUL
GOTO lbl_210___end
:lbl_210_ortfac_short
COPY _internal\_run_short_testortfacunit.cs _tmp\_test.cs > NUL 2> NUL
COPY tests\testortfacunit.* _tmp > NUL 2> NUL
GOTO lbl_210___end
:lbl_210_ortfac_silent
COPY _internal\_run_silent_testortfacunit.cs _tmp\_test.cs > NUL 2> NUL
COPY tests\testortfacunit.* _tmp > NUL 2> NUL
GOTO lbl_210___end
:lbl_210_rotations
echo No separate test file for this unit
...
EXIT /B 0
GOTO lbl_210___end
:lbl_210_rotations_short
EXIT /B 0
GOTO lbl_210___end
:lbl_210_rotations_silent
EXIT /B 0
GOTO lbl_210___end
:lbl_210_hsschur
echo No separate test file for this unit
...
EXIT /B 0
GOTO lbl_210___end
:lbl_210_hsschur_short
EXIT /B 0
GOTO lbl_210___end
:lbl_210_hsschur_silent
EXIT /B 0
GOTO lbl_210___end
:lbl_210_evd
COPY _internal\_run_testevdunit.cs _tmp\_test.cs > NUL 2> NUL
COPY tests\testevdunit.* _tmp > NUL 2> NUL
GOTO lbl_210___end
:lbl_210_evd_short
COPY _internal\_run_short_testevdunit.cs _tmp\_test.cs > NUL 2> NUL
COPY tests\testevdunit.* _tmp > NUL 2> NUL
GOTO lbl_210___end
:lbl_210_evd_silent
COPY _internal\_run_silent_testevdunit.cs _tmp\_test.cs > NUL 2> NUL
COPY tests\testevdunit.* _tmp > NUL 2> NUL
GOTO lbl_210___end
:lbl_210_hqrnd
...
COPY tests\testrcondunit.* _tmp > NUL 2> NUL
GOTO lbl_210___end
:lbl_210_rcond_silent
COPY _internal\_run_silent_testrcondunit.cs _tmp\_test.cs > NUL 2> NUL
COPY tests\testrcondunit.* _tmp > NUL 2> NUL
GOTO lbl_210___end
:lbl_210_matinv
COPY _internal\_run_testmatinvunit.cs _tmp\_test.cs > NUL 2> NUL
COPY tests\testmatinvunit.* _tmp > NUL 2> NUL
GOTO lbl_210___end
:lbl_210_matinv_short
COPY _internal\_run_short_testmatinvunit.cs _tmp\_test.cs > NUL 2> NUL
COPY tests\testmatinvunit.* _tmp > NUL 2> NUL
GOTO lbl_210___end
:lbl_210_matinv_silent
COPY _internal\_run_silent_testmatinvunit.cs _tmp\_test.cs > NUL 2> NUL
COPY tests\testmatinvunit.* _tmp > NUL 2> NUL
GOTO lbl_210___end
:lbl_210_linreg
...
EXIT /B 0
GOTO lbl_210___end
:lbl_210_normaldistr_short
EXIT /B 0
GOTO lbl_210___end
:lbl_210_normaldistr_silent
EXIT /B 0
GOTO lbl_210___end
:lbl_210_igammaf
echo No separate test file for this unit
...
EXIT /B 0
GOTO lbl_210___end
:lbl_210_igammaf_short
EXIT /B 0
GOTO lbl_210___end
:lbl_210_igammaf_silent
EXIT /B 0
GOTO lbl_210___end
:lbl_210_bdsvd
...
EXIT /B 0
GOTO lbl_210___end
:lbl_210_mlpbase_short
EXIT /B 0
GOTO lbl_210___end
:lbl_210_mlpbase_silent
EXIT /B 0
GOTO lbl_210___end
:lbl_210_xblas
...
GOTO lbl_210___end
:lbl_210_linmin
COPY _internal\_run_testlinminunit.cs _tmp\_test.cs > NUL 2> NUL
COPY tests\testlinminunit.* _tmp > NUL 2> NUL
GOTO lbl_210___end
:lbl_210_linmin_short
COPY _internal\_run_short_testlinminunit.cs _tmp\_test.cs > NUL 2> NUL
COPY tests\testlinminunit.* _tmp > NUL 2> NUL
GOTO lbl_210___end
:lbl_210_linmin_silent
COPY _internal\_run_silent_testlinminunit.cs _tmp\_test.cs > NUL 2> NUL
COPY tests\testlinminunit.* _tmp > NUL 2> NUL
GOTO lbl_210___end
:lbl_210_minlbfgs
COPY _internal\_run_testminlbfgsunit.cs _tmp\_test.cs > NUL 2> NUL
COPY tests\testminlbfgsunit.* _tmp > NUL 2> NUL
GOTO lbl_210___end
:lbl_210_minlbfgs_short
COPY _internal\_run_short_testminlbfgsunit.cs _tmp\_test.cs > NUL 2> NUL
COPY tests\testminlbfgsunit.* _tmp > NUL 2> NUL
GOTO lbl_210___end
:lbl_210_minlbfgs_silent
COPY _internal\_run_silent_testminlbfgsunit.cs _tmp\_test.cs > NUL 2> NUL
COPY tests\testminlbfgsunit.* _tmp > NUL 2> NUL
GOTO lbl_210___end
:lbl_210_mlptrain
...
EXIT /B 0
GOTO lbl_210___end
:lbl_210_ftbase_short
EXIT /B 0
GOTO lbl_210___end
:lbl_210_ftbase_silent
EXIT /B 0
GOTO lbl_210___end
:lbl_210_fft
...
COPY tests\llstestunit.* _tmp > NUL 2> NUL
GOTO lbl_210___end
:lbl_210_lsfit_silent
COPY _internal\_run_silent_llstestunit.cs _tmp\_test.cs > NUL 2> NUL
COPY tests\llstestunit.* _tmp > NUL 2> NUL
GOTO lbl_210___end
:lbl_210_minlm
COPY _internal\_run_testminlmunit.cs _tmp\_test.cs > NUL 2> NUL
COPY tests\testminlmunit.* _tmp > NUL 2> NUL
GOTO lbl_210___end
:lbl_210_minlm_short
COPY _internal\_run_short_testminlmunit.cs _tmp\_test.cs > NUL 2> NUL
COPY tests\testminlmunit.* _tmp > NUL 2> NUL
GOTO lbl_210___end
:lbl_210_minlm_silent
COPY _internal\_run_silent_testminlmunit.cs _tmp\_test.cs > NUL 2> NUL
COPY tests\testminlmunit.* _tmp > NUL 2> NUL
GOTO lbl_210___end
:lbl_210_polint
...
EXIT /B 0
GOTO lbl_210___end
:lbl_210_apserv_short
EXIT /B 0
GOTO lbl_210___end
:lbl_210_apserv_silent
EXIT /B 0
GOTO lbl_210___end
:lbl_210_spline2d
COPY _internal\_run_testspline2dunit.cs _tmp\_test.cs > NUL 2> NUL
COPY tests\testspline2dunit.* _tmp > NUL 2> NUL
GOTO lbl_210___end
:lbl_210_spline2d_short
COPY _internal\_run_short_testspline2dunit.cs _tmp\_test.cs > NUL 2> NUL
COPY tests\testspline2dunit.* _tmp > NUL 2> NUL
GOTO lbl_210___end
:lbl_210_spline2d_silent
COPY _internal\_run_silent_testspline2dunit.cs _tmp\_test.cs > NUL 2> NUL
COPY tests\testspline2dunit.* _tmp > NUL 2> NUL
GOTO lbl_210___end
:lbl_210_spline3
echo No separate test file for this unit
...
EXIT /B 0
GOTO lbl_210___end
:lbl_210_spline3_short
EXIT /B 0
GOTO lbl_210___end
:lbl_210_spline3_silent
EXIT /B 0
GOTO lbl_210___end
:lbl_210_spline1d
COPY _internal\_run_testspline1dunit.cs _tmp\_test.cs > NUL 2> NUL
COPY tests\testspline1dunit.* _tmp > NUL 2> NUL
GOTO lbl_210___end
:lbl_210_spline1d_short
COPY _internal\_run_short_testspline1dunit.cs _tmp\_test.cs > NUL 2> NUL
COPY tests\testspline1dunit.* _tmp > NUL 2> NUL
GOTO lbl_210___end
:lbl_210_spline1d_silent
COPY _internal\_run_silent_testspline1dunit.cs _tmp\_test.cs > NUL 2> NUL
COPY tests\testspline1dunit.* _tmp > NUL 2> NUL
GOTO lbl_210___end
:lbl_210_idwint
COPY _internal\_run_testidwunit.cs _tmp\_test.cs > NUL 2> NUL
COPY tests\testidwunit.* _tmp > NUL 2> NUL
GOTO lbl_210___end
:lbl_210_idwint_short
COPY _internal\_run_short_testidwunit.cs _tmp\_test.cs > NUL 2> NUL
COPY tests\testidwunit.* _tmp > NUL 2> NUL
GOTO lbl_210___end
:lbl_210_idwint_silent
COPY _internal\_run_silent_testidwunit.cs _tmp\_test.cs > NUL 2> NUL
COPY tests\testidwunit.* _tmp > NUL 2> NUL
GOTO lbl_210___end
:lbl_210_nearestneighbor
COPY _internal\_run_testnearestneighborunit.cs _tmp\_test.cs > NUL 2> NUL
COPY tests\testnearestneighborunit.* _tmp > NUL 2> NUL
GOTO lbl_210___end
:lbl_210_nearestneighbor_short
COPY _internal\_run_short_testnearestneighborunit.cs _tmp\_test.cs > NUL 2> NUL
COPY tests\testnearestneighborunit.* _tmp > NUL 2> NUL
GOTO lbl_210___end
:lbl_210_nearestneighbor_silent
COPY _internal\_run_silent_testnearestneighborunit.cs _tmp\_test.cs > NUL 2> NUL
COPY tests\testnearestneighborunit.* _tmp > NUL 2> NUL
GOTO lbl_210___end
:lbl_210_pspline
COPY _internal\_run_testpsplineunit.cs _tmp\_test.cs > NUL 2> NUL
COPY tests\testpsplineunit.* _tmp > NUL 2> NUL
GOTO lbl_210___end
:lbl_210_pspline_short
COPY _internal\_run_short_testpsplineunit.cs _tmp\_test.cs > NUL 2> NUL
COPY tests\testpsplineunit.* _tmp > NUL 2> NUL
GOTO lbl_210___end
:lbl_210_pspline_silent
COPY _internal\_run_silent_testpsplineunit.cs _tmp\_test.cs > NUL 2> NUL
COPY tests\testpsplineunit.* _tmp > NUL 2> NUL
GOTO lbl_210___end
:lbl_210_matdet
echo No separate test file for this unit
...
EXIT /B 0
GOTO lbl_210___end
:lbl_210_matdet_short
EXIT /B 0
GOTO lbl_210___end
:lbl_210_matdet_silent
EXIT /B 0
GOTO lbl_210___end
:lbl_210_sdet
echo No separate test file for this unit
...
EXIT /B 0
GOTO lbl_210___end
:lbl_210_ssolve_short
EXIT /B 0
GOTO lbl_210___end
:lbl_210_ssolve_silent
EXIT /B 0
GOTO lbl_210___end
:lbl_210_estnorm
echo No separate test file for this unit
...
EXIT /B 0
GOTO lbl_210___end
:lbl_210_estnorm_short
EXIT /B 0
GOTO lbl_210___end
:lbl_210_estnorm_silent
EXIT /B 0
GOTO lbl_210___end
:lbl_210_schur
...
COPY tests\testschurunit.* _tmp > NUL 2> NUL
GOTO lbl_210___end
:lbl_210_schur_silent
COPY _internal\_run_silent_testschurunit.cs _tmp\_test.cs > NUL 2> NUL
COPY tests\testschurunit.* _tmp > NUL 2> NUL
GOTO lbl_210___end
:lbl_210_mincg
COPY _internal\_run_testmincgunit.cs _tmp\_test.cs > NUL 2> NUL
COPY tests\testmincgunit.* _tmp > NUL 2> NUL
GOTO lbl_210___end
:lbl_210_mincg_short
COPY _internal\_run_short_testmincgunit.cs _tmp\_test.cs > NUL 2> NUL
COPY tests\testmincgunit.* _tmp > NUL 2> NUL
GOTO lbl_210___end
:lbl_210_mincg_silent
COPY _internal\_run_silent_testmincgunit.cs _tmp\_test.cs > NUL 2> NUL
COPY tests\testmincgunit.* _tmp > NUL 2> NUL
GOTO lbl_210___end
:lbl_210_minasa
COPY _internal\_run_testasa.cs _tmp\_test.cs > NUL 2> NUL
COPY tests\testasa.* _tmp > NUL 2> NUL
GOTO lbl_210___end
:lbl_210_minasa_short
COPY _internal\_run_short_testasa.cs _tmp\_test.cs > NUL 2> NUL
COPY tests\testasa.* _tmp > NUL 2> NUL
GOTO lbl_210___end
:lbl_210_minasa_silent
COPY _internal\_run_silent_testasa.cs _tmp\_test.cs > NUL 2> NUL
COPY tests\testasa.* _tmp > NUL 2> NUL
GOTO lbl_210___end
:lbl_210_airyf
echo No separate test file for this unit
...
EXIT /B 0
GOTO lbl_210___end
:lbl_210_bessel_short
EXIT /B 0
GOTO lbl_210___end
:lbl_210_bessel_silent
EXIT /B 0
GOTO lbl_210___end
:lbl_210_betaf
echo No separate test file for this unit
...
EXIT /B 0
GOTO lbl_210___end
:lbl_210_dawson_short
EXIT /B 0
GOTO lbl_210___end
:lbl_210_dawson_silent
EXIT /B 0
GOTO lbl_210___end
:lbl_210_elliptic
echo No separate test file for this unit
...
EXIT /B 0
GOTO lbl_210___end
:lbl_210_elliptic_short
EXIT /B 0
GOTO lbl_210___end
:lbl_210_elliptic_silent
EXIT /B 0
GOTO lbl_210___end
:lbl_210_expintegrals
echo No separate test file for this unit
echo It is tested somewhere else
EXIT /B 0
GOTO lbl_210___end
:lbl_210_expintegrals_short
EXIT /B 0
GOTO lbl_210___end
:lbl_210_expintegrals_silent
EXIT /B 0
GOTO lbl_210___end
:lbl_210_fresnel
echo No separate test file for this unit
...
EXIT /B 0
GOTO lbl_210___end
:lbl_210_fresnel_short
EXIT /B 0
GOTO lbl_210___end
:lbl_210_fresnel_silent
EXIT /B 0
GOTO lbl_210___end
:lbl_210_hermite
...
EXIT /B 0
GOTO lbl_210___end
:lbl_210_ibetaf_short
EXIT /B 0
GOTO lbl_210___end
:lbl_210_ibetaf_silent
EXIT /B 0
GOTO lbl_210___end
:lbl_210_jacobianelliptic
echo No separate test file for this unit
echo It is tested somewhere else
EXIT /B 0
GOTO lbl_210___end
:lbl_210_jacobianelliptic_short
EXIT /B 0
GOTO lbl_210___end
:lbl_210_jacobianelliptic_silent
EXIT /B 0
GOTO lbl_210___end
:lbl_210_laguerre
...
EXIT /B 0
GOTO lbl_210___end
:lbl_210_trigintegrals
echo No separate test file for this unit
echo It is tested somewhere else
EXIT /B 0
GOTO lbl_210___end
:lbl_210_trigintegrals_short
EXIT /B 0
GOTO lbl_210___end
:lbl_210_trigintegrals_silent
EXIT /B 0
GOTO lbl_210___end
:lbl_210_binomialdistr
echo No separate test file for this unit
echo It is tested somewhere else
EXIT /B 0
GOTO lbl_210___end
:lbl_210_binomialdistr_short
EXIT /B 0
GOTO lbl_210___end
:lbl_210_binomialdistr_silent
EXIT /B 0
GOTO lbl_210___end
:lbl_210_nearunityunit
echo No separate test file for this unit
echo It is tested somewhere else
EXIT /B 0
GOTO lbl_210___end
:lbl_210_nearunityunit_short
EXIT /B 0
GOTO lbl_210___end
:lbl_210_nearunityunit_silent
EXIT /B 0
GOTO lbl_210___end
:lbl_210_chisquaredistr
echo No separate test file for this unit
echo It is tested somewhere else
EXIT /B 0
GOTO lbl_210___end
:lbl_210_chisquaredistr_short
EXIT /B 0
GOTO lbl_210___end
:lbl_210_chisquaredistr_silent
EXIT /B 0
GOTO lbl_210___end
:lbl_210_correlation
echo No separate test file for this unit
...
EXIT /B 0
GOTO lbl_210___end
:lbl_210_correlation_short
EXIT /B 0
GOTO lbl_210___end
:lbl_210_correlation_silent
EXIT /B 0
GOTO lbl_210___end
:lbl_210_fdistr
echo No separate test file for this unit
...
EXIT /B 0
GOTO lbl_210___end
:lbl_210_fdistr_short
EXIT /B 0
GOTO lbl_210___end
:lbl_210_fdistr_silent
EXIT /B 0
GOTO lbl_210___end
:lbl_210_correlationtests
echo No separate test file for this unit
echo It is tested somewhere else
EXIT /B 0
GOTO lbl_210___end
:lbl_210_correlationtests_short
EXIT /B 0
GOTO lbl_210___end
:lbl_210_correlationtests_silent
EXIT /B 0
GOTO lbl_210___end
:lbl_210_studenttdistr
echo No separate test file for this unit
echo It is tested somewhere else
EXIT /B 0
GOTO lbl_210___end
:lbl_210_studenttdistr_short
EXIT /B 0
GOTO lbl_210___end
:lbl_210_studenttdistr_silent
EXIT /B 0
GOTO lbl_210___end
:lbl_210_jarquebera
echo No separate test file for this unit
...
EXIT /B 0
GOTO lbl_210___end
:lbl_210_jarquebera_short
EXIT /B 0
GOTO lbl_210___end
:lbl_210_jarquebera_silent
EXIT /B 0
GOTO lbl_210___end
:lbl_210_mannwhitneyu
echo No separate test file for this unit
echo It is tested somewhere else
EXIT /B 0
GOTO lbl_210___end
:lbl_210_mannwhitneyu_short
EXIT /B 0
GOTO lbl_210___end
:lbl_210_mannwhitneyu_silent
EXIT /B 0
GOTO lbl_210___end
:lbl_210_poissondistr
echo No separate test file for this unit
echo It is tested somewhere else
EXIT /B 0
GOTO lbl_210___end
:lbl_210_poissondistr_short
EXIT /B 0
GOTO lbl_210___end
:lbl_210_poissondistr_silent
EXIT /B 0
GOTO lbl_210___end
:lbl_210_stest
echo No separate test file for this unit
...
EXIT /B 0
GOTO lbl_210___end
:lbl_210_stest_silent
EXIT /B 0
GOTO lbl_210___end
:lbl_210_studentttests
echo No separate test file for this unit
echo It is tested somewhere else
EXIT /B 0
GOTO lbl_210___end
:lbl_210_studentttests_short
EXIT /B 0
GOTO lbl_210___end
:lbl_210_studentttests_silent
EXIT /B 0
GOTO lbl_210___end
:lbl_210_variancetests
echo No separate test file for this unit
echo It is tested somewhere else
EXIT /B 0
GOTO lbl_210___end
:lbl_210_variancetests_short
EXIT /B 0
GOTO lbl_210___end
:lbl_210_variancetests_silent
EXIT /B 0
GOTO lbl_210___end
:lbl_210_wsr
echo No separate test file for this unit
...
EXIT /B 1
:lbl_210___end
IF "%~1"=="csc" GOTO lbl_211_csc
IF "%~1"=="mono" GOTO lbl_211_mono
GOTO lbl_211___error
:lbl_211_csc
CHDIR _tmp
