        ...
        * store it in State.DY
        Here State.X is real, State.Y and State.DY are arrays[0..N-1] of reals.
          ...
          -- ALGLIB --
             Copyright 01.09.2009 by Bochkanov Sergey
        *************************************************************************/
        public static bool odesolveriteration(ref odesolverstate state)
        {
            ...
            //
            System.Diagnostics.Debug.Assert((double)(state.h)>(double)(0), "ODESolver: internal error");
            System.Diagnostics.Debug.Assert(m>1, "ODESolverIteration: internal error");
