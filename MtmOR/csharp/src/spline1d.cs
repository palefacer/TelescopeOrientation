    ...
    public class spline1d
    {
        ...
        *************************************************************************/
            ...
            ref spline1dinterpolant c)
        {
            ...
            System.Diagnostics.Debug.Assert(n>=2, "Spline1DBuildCubic: N<2!");
            System.Diagnostics.Debug.Assert(boundltype==-1 | boundltype==0 | boundltype==1 | boundltype==2, "Spline1DBuildCubic: incorrect BoundLType!");
            System.Diagnostics.Debug.Assert(boundrtype==-1 | boundrtype==0 | boundrtype==1 | boundrtype==2, "Spline1DBuildCubic: incorrect BoundRType!");
            System.Diagnostics.Debug.Assert(boundrtype==-1 & boundltype==-1 | boundrtype!=-1 & boundltype!=-1, "Spline1DBuildCubic: incorrect BoundLType/BoundRType!");
            ...
            if( boundrtype==-1 & boundltype==-1 )
            {
                ...
                //
                solvecyclictridiagonal(ref a1, a2, ref a3, ref b, n-1, ref dt);
                d = new double[n];
                for(i_=0; i_<=n-2;i_++)
                {
                    d[i_] = dt[i_];
        ...
        *************************************************************************/
        ...
        ( C[N-1]           A[N-1] B[N-1] )
        *************************************************************************/
        private static void solvecyclictridiagonal(ref double[] a,
            double[] b,
            ref double[] c,
            ref double[] d,
            int n,
