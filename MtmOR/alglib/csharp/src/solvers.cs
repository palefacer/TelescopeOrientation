    ...
    public class nleq
    {
        ...
        *************************************************************************/
        ...
        lbl_9:
            ...
            fbls.fblssolvecgx(state.j, m, n, Math.Sqrt(state.fbase)+lambdav, state.rightpart, ref state.candstep, ref state.cgbuf);
        ...
        lbl_10:
            ...
            // * new function value
            //
            // We explicitly add StepNorm*CandStep[] to the XBase instead of
            // using State.X because State.X is visible to user and it is
            // possible than user will accidentally modify its value.
            // So we prefer somewhat redundant but safe solution.
            //
            state.fbase = state.f;
            for(i_=0; i_<=n-1;i_++)
            {
