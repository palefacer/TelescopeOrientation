...
public partial class alglib
{
    ...
    *************************************************************************/
    public static void samplemoments(double[] x, int n, out double mean, out double variance, out double skewness, out double kurtosis)
    {
        ...
        skewness = 0;
        kurtosis = 0;
        descstat.samplemoments(x, n, ref mean, ref variance, ref skewness, ref kurtosis);
        return;
    }
    ...
    *************************************************************************/
    ...
    {
        adev = 0;
        descstat.sampleadev(x, n, ref adev);
        return;
    }
    ...
    *************************************************************************/
    ...
    {
        median = 0;
        descstat.samplemedian(x, n, ref median);
        return;
    }
    ...
    *************************************************************************/
    ...
    {
        v = 0;
        descstat.samplepercentile(x, n, p, ref v);
        return;
    }
...
public partial class alglib
{
    ...
    *************************************************************************/
    public static double pearsoncorrelation(double[] x, double[] y, int n)
    {
        ...
        double result = correlation.pearsoncorrelation(x, y, n);
        return result;
    }
    ...
    *************************************************************************/
    public static double spearmanrankcorrelation(double[] x, double[] y, int n)
    {
        ...
        double result = correlation.spearmanrankcorrelation(x, y, n);
        return result;
    }
    ...
    public class descstat
    {
        ...
        *************************************************************************/
            ...
            ref double v)
        {
            ...
            ap.assert(n>1, "CalculatePercentile: N<=1!");
            ap.assert((double)(p)>=(double)(0) & (double)(p)<=(double)(1), "CalculatePercentile: incorrect P!");
        ...
        /*************************************************************************
        This subroutine is here for backward compatibility only.
        *************************************************************************/
        public static void calculatemoments(double[] x,
            int n,
            ref double mean,
            ref double variance,
            ref double skewness,
            ref double kurtosis)
        {
            ...
            samplemoments(x, n, ref mean, ref variance, ref skewness, ref kurtosis);
        }
        ...
        This subroutine is here for backward compatibility only.
        *************************************************************************/
        public static void calculateadev(double[] x,
            int n,
            ref double adev)
        {
            adev = 0;

            sampleadev(x, n, ref adev);
        }
