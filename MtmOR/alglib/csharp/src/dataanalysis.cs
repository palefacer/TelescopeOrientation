        ...
        *************************************************************************/
            ...
            ref double[] sigmas)
        {
            ...
            for(j=0; j<=nvars-1; j++)
            {
                ...
                descstat.calculatemoments(tmp, npoints, ref mean, ref variance, ref skewness, ref kurtosis);
                means[j] = mean;
        ...
        *************************************************************************/
            ...
            lrreport ar)
        {
            ...
            for(j=0; j<=nvars-1; j++)
            {
                ...
                descstat.calculatemoments(x, npoints, ref mean, ref variance, ref skewness, ref kurtosis);
                means[j] = mean;
                sigmas[j] = Math.Sqrt(variance);
                if( (double)(sigmas[j])==(double)(0) )
                {
        ...
        *************************************************************************/
            ...
            ref double[,] v)
        {
            ...
            for(j=0; j<=nvars-1; j++)
            {
                ...
                descstat.calculatemoments(t, npoints, ref mean, ref variance, ref skewness, ref kurtosis);
                m[j] = mean;
            }
